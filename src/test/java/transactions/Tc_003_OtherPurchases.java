...
public class Tc_003_OtherPurchases extends BaseClass {
	...
	public void expencesYesItcYes() throws Exception {
		...
		String modulename = "OtherPurchases ITC Eligible";
		String invoicedate = Todaydate;
		String invoicenumber = RandomInt;
		String vendorname = result.get(2); // Assuming 'custname' maps to 'vendorname' in the table
		String productName = "QaTester";
		String hsn = Sqldata;
		int quantity = 540;
		String units = "Bags";
		int unitrate = 100;
		...
		String modulename2 = "OtherPurchases ITC Eligible 2";
		String invoicedate2 = Todaydate;
		String invoicenumber2 = RandomInt;
		String vendorname2 = result.get(2); // Assuming 'custname' maps to 'vendorname' in the table
		...
		String modulename3 = "OtherPurchases ITC Eligible 3";
		String invoicedate3 = Todaydate;
		String invoicenumber3 = RandomInt;
		String vendorname3 = result.get(2); // Assuming 'custname' maps to 'vendorname' in the table
		...
		String modulename4 = "OtherPurchases ITC Eligible 4";
		String invoicedate4 = Todaydate;
		String invoicenumber4 = RandomInt;
		String vendorname4 = result.get(2); // Assuming 'custname' maps to 'vendorname' in the table
	...
	public void expensesYesItcNo() throws Exception {
		...
		String script1 = "var dataList = document.getElementById('custvend');\n"
                ...
                + "var texts = [];\n"
                + "for (var i = 0; i < options.length; i++) {\n"
                + "    texts.push(options[i].textContent);\n" // Using textContent to get the text of the option
                + "}\n"
                + "return texts;";
